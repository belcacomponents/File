...
class CreateFilesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('files', function (Blueprint $table) {
           ...
           * и может использоваться при группировках файлов.
           */
           ...
           * совпадать с полем type или с полем extension (зависит от возможностей
           * драйвера).
           *
           * Если у файла нету обработчика, то ему присваивается значение other.
           * Такие файлы не имеют общей группы и никак не обрабатываются (сохраняются
           * в неизменном виде).
           */
